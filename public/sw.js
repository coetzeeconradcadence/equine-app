...
const CACHE = 'hoofnote-v1';
const SHELL = [
  './', 'index.html', 'css/app.css', 'manifest.webmanifest', 'icons/icon.svg',
  'js/app.js', 'js/config.js', 'js/util.js', 'js/db.js', 'js/forms.js', 'js/schemas.js', 'js/ahs.js', 'js/due.js', 'js/demo.js',
  'js/views/components.js', 'js/views/home.js', 'js/views/horses.js', 'js/views/lists.js', 'js/views/print.js',
  'js/views/blog.js', 'js/views/ai.js', 'js/views/settings.js',
];
